...
\end{center}
 ...
 \begin{figure}[htb]
    ...
    \caption*{L'uomo con gli occhiali seduto al centro è \textbf{Domenico Soatti}, "Mingò 'd Galèna"\index[Personaggi]{Domenico Soatti `Mingò d'Galèna` (infermiere)}, mentre i due uomini in piedi a destra sono in ordine: Stefano Mingazzi e \index[Personaggi]{Isani Nando}Nando Isani\label{fig:mingò}}
    %\vspace{-0.3cm}
\end{figure}
