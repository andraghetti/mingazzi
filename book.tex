...
%SISTEMARE, prima prefazione e poi biografia?
...
\begin{center}
\vspace{-20pt}
   \includegraphics[height=0.88\textheight]{"indice".jpeg}\\
  \end{center}
\end{figure}
...
Il signor \index[Personaggi]{Camerani Matteo (farmacista)}Matteo C.\:.\:.\footnote{Matteo Camerani fu un farmacista e fu figlio di Giovan Antonio, governatore di Alfonsine e figlio di Maria Cristina Monti, sorella del poeta Vincenzo Monti. Può sembrare confusionaria la genealogia ma è di fatto: Matteo (fattore), Giovan Antonio (governatore), Matteo (farmacista), Giovan Antonio} aveva fatto scodellare la minestra per sé, la moglie, ed i 4 figli e con la moglie cominciarono a soffiare sulle prime cucchiaiate perchè si raffreddasse.\\
...
\begin{center}
\vspace{-10pt}
   \includegraphics[height=0.48\textheight]{"Lisco".jpg}\\
...
\begin{center}
\vspace{-4pt}
   \includegraphics[height=0.25\textheight]{"Capelli_Avvocato".jpg}\\
  \end{center}
  \vspace{-102pt}
\end{figure}
\newpage
\index[Personaggi]{Capelli (protocollista)}Sotto l'altro\footnote{E ora parliamo dell'altro}. \\Per questo la gola fu fatale. I tortelli hanno ucciso Capelli, questa orrenda notizia vi dò!\\
...
\begin{center}
\vspace{-10pt}
   \includegraphics[height=0.9\textheight]{"Capelli_mangione".jpg}\\
  \end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
   \includegraphics[height=0.8\textheight, width=\textwidth]{"Gioti2".jpg}\\
  \end{center}
\end{figure}
...
\begin{center}
\vspace{-10pt}
   \includegraphics[height=0.8\textheight]{"lettera".jpg}\\
  \end{center}
\end{figure}
...
\begin{center}
\vspace{-10pt}
   \includegraphics[height=0.40\textheight]{"FabbriCesare".jpeg}\\
  \end{center}
\end{figure}
