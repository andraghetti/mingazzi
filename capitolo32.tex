...
\begin{figure}[hbt]%
	\vspace{-1cm}
    \centering
    \subfloat[Il santuario della Madonna dei Boschi]{{\includegraphics[height=7cm]{santuario} }}%
    \subfloat[Il Pilastrino della Madonna]{{\includegraphics[height=7cm]{pilastrino} }}%
	\vspace{-0.2cm}
\end{figure}