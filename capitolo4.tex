...
\vspace{0.2cm}
 ...
 \begin{figure}[htb]
    ...
    \caption*{\index[Personaggi]{Mingazzi Stefano}Mingazzi a destra e sotto la governante `Ghina' con il cane pastore maremmano di Stefano, `Negar'. A sinistra si riconosce un giovane \index[Personaggi]{Zoli Cesare}Cesare Zoli. Le tre persone al centro non sono state riconosciute. La foto dovrebbe essere stata scattata attorno al 1925 quando Mingazzi non era ancora sposato.\label{fig:mingazzigente}}
    %\vspace{-0.3cm}
\end{figure}