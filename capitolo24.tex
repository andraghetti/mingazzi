...
\indent Per quel carnevale... fu una quaresima per gli innamorati\footnote{Mentre le campane erano fuori uso, i ragazzi potevano festeggiare il carnevale liberamente}.
 ...
 \begin{figure}[htb]
    ...
    \caption[Arcipretale Santa Maria]{La chiesa \textbf{Arcipretale Santa Maria} in Piazza \index[Luoghi]{Piazza Vincenzo Monti}Monti con a fianco la canonica, fotografata durante una processione.\label{fig:chiesa}}
    \vspace{-0.7cm}
\end{figure}
