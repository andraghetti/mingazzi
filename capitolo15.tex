...
\indent Furono requisiti generi, carri, carrettieri e contadini per trasportare gli equipaggiamenti e servizi austriaci fino all'altra tappa di \index[Luoghi]{Argenta}Argenta.
 ...
 \begin{figure}[htb]
    ...
    \caption*{Una foto del Palazzo \index[Luoghi]{Lugaresi (palazzo)}Lugaresi, al centro, ancora in piedi, ma segnato dalle prime bombe del 1943. Il palazzo in primo piano, sulla destra è la \index[Luoghi]{Casa del Fascio}Casa del Fascio.\label{fig:lugaresi}}
    \vspace{-0.5cm}
\end{figure}
