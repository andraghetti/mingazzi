...
\setlrmarginsandblock{1.7cm}{1.3cm}{*}% % Left/right margins
...
\counterwithout{figure}{chapter} % per avere numeri sequenziali in LOF

 % per avere niente spazio tra figure in LOF
