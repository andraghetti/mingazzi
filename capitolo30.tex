...
\indent Peccato che non sia stata consacrata a verbale questa genuina proposta!
 ...
 \begin{figure}[htb]
    ...
    \caption*{Anselmo Alberani\index[Personaggi]{Alberani Anselmo}, uno dei più ricchi proprietari terrieri di, fu pretore di Alfonsine. Era il padre di Alberto\index[Personaggi]{Alberani Alberto}, che fu Sindaco di Alfonsine dal 1922 al 1924.\label{fig:alberani}}
    %\vspace{-0.3cm}
\end{figure}