...
\indent Un giorno usciva dalla scuola del \index[Luoghi]{Borgo Gallina}Borgo Gallina\footnote{Detto anche Borgo Fratti, è la zona a ridosso del fiume in via Antonio Fratti}, sul mezzogiorno, incontra una vecchietta, con affabilità, sottovoce e gran circospezione, le dice: <<Buona donna, spendendo poco si potrebbe fare uno spuntino?>>.\\
...
\indent E le cose si accodarono tra la vecchia e il cavaliere.
 ...
 \begin{figure}[htb]
    ...
    \caption[Scuole Comunali]{Le \textbf{Scuole Comunali}\index[Luoghi]{Scuole Comunali} di Alfonsine, in \index[Luoghi]{Corso Garibaldi}Corso Garibaldi. Si può osservare sulla sinistra il monumento della Pigna che attualmente è nel parchetto di fronte alla Chiesa Sacro Cuore.\label{fig:scuole}}
    %\vspace{-0.3cm}
\end{figure}
