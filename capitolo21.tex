...
\indent E le cose si accodarono tra la vecchia e il cavaliere.
 ...
 \begin{figure}[htb]
    ...
    \caption*{Le scuole comunale di Alfonsine, in Corso Garibaldi. Si può osservare sulla sinistra il monumento della Pigna che attualmente è nel parchetto di fronte alla Chiesa Sacro Cuore.\label{fig:scuole}}
    %\vspace{-0.3cm}
\end{figure}