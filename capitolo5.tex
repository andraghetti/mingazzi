...
Con questa chiusa\footnote{Conclusione} cominciò la sua nuova officiatura al \index[Luoghi]{Passetto}Passetto. Colà i contadini andavano a messa con lo schioppo\footnote{Fucile da caccia}, del quale il nostro don Matteo\index[Personaggi]{Don G. Matteo} aveva un sacrosanto terrore. Allora uscì in uno dei suoi predicozzi:\\
...
\vspace{1cm}
 ...
 \begin{figure}[htb]
    \centering
    %\vspace{-0.7cm}
    \includegraphics[width=\textwidth]{marianna}
    \caption[Tenuta Marianna]{\index[Luoghi]{Conventello}Conventello, \index[Luoghi]{Azienda Marianna}Azienda Marianna (1919)\label{fig:marianna}}
    %\vspace{-0.3cm}
\end{figure}
